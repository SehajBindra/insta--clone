  ...
  return (
    <div>
      <div className="flex justify-between max-w-6xl mx-5 xl:mx-auto ">
       ...
       <RiMessengerLine className="h-6 w-6  navBtn" />
       <div className=" absolute -top-1 -right-2  text-xs w-5 h-5 bg-red-500  rounded-full flex items-center  justify-center animate-ping text-white ">18</div>
       </div>

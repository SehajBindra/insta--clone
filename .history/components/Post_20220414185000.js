...
function Post({ id, username, userImg, img, caption }) {
  ...
  return (
    <div className="  bg-white my-7 border rounded-sm">
      ...
      {/* comments */}
      {comments.length > 0 && (
        <div className=" flex justify-center ml-10 h-20 overflow-y-scroll scrollbar-thumb-black scrollbar-thin">
          {comments.map((comment) => (
            <div className=" flex items-center justify-start space-x-2 mb-2 " key={comment.id}>
              <img
              ...
              <Moment className=" p-5 text-sm "  fromNow >

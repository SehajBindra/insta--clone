    ...
    <div className="shadow-sm border-b  bg-white sticky top-0 z-50">
      <div className="flex justify-between max-w-6xl mx-5 xl:mx-auto ">
        ...
        <div className=" relative mt-1  p-3 rounded-md ">
            ...
            <input className="hidden    bg-gray-50 block w-full pl-10 sm:text-sm border-gray-300  focus:ring-black  focus:border-black rounded-md" type="text" placeholder="Search" />
       ...
       <MenuIcon className=" h-6 md:hidden cursor-pointer " />
         ...
         {session ? (
           ...
           <img onClick={signOut} className="h-6 w-6 rounded-full  cursor-pointer" src={session?.user?.image} alt="profile pic"  />
           </>
         ) : (
